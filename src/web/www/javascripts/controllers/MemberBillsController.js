    ...
    Index: function(options){
        ...
        getAPIData({
            ...
            success: function (data){
                ...
                if (options.pushed){
                    GATrackPage('MemberBillsView', member.name);
                }
                ...
                getAPIData({
                    ...
                    success: function (billsData){
                    	...
                    	billList = that.billsView.query('#MemberBillList')[0];
                    	
                        OKnesset.BillsStore.loadData(billsData.bills);
                		OKnesset.BillsStore.sort(OKnesset.BillsStoreSorters.byStage);
                        ...
                        that.billsView.memberBillListTitle.update({
